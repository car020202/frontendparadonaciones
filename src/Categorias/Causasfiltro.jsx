            ...
            <div className="causas-cards" style={{
              ...
              {causas.map((causa) => (
                <div key={causa.id} className="causa-card" style={{
                  ...
                  <img src={`http://localhost:3000${causa.portada}`}alt={`Causa ${causa.nombreCausa}`} style={{ width: '100%', height: '200px', objectFit: 'cover', borderRadius: '10px', marginBottom: '10px' }} />
                  <div style={{ padding: '10px' }}>
                    ...
                    <button
                      ...
                      style={{ backgroundColor: '#007B8A', color: 'white', border: 'none', padding: '10px 20px', borderRadius: '5px', cursor: 'pointer', marginTop: '10px' }}
                    >
                      Ver
                    </button>
                  </div>
